...
class LedgerSpec extends ObjectBehavior
{
    ...
    {
        $items = [
            $itemOne = LedgerItem::from(1000, null, 300.00, 55000, null, 'Some Item', '2016-02-03'),
            $itemTwo = LedgerItem::from(1000, null, 200.00, 55000, null, 'Some Item', '2016-02-03'),
        ];

        $response->getStatusCode()->willReturn(201);
        $client->post('/ledgeritems', $items)->willReturn($response);
